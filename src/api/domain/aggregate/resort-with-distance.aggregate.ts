...
import { ResortServices } from '../../../shared/domain/enum/resort-services.enum';
import { Collection } from '../../../shared/domain/value-objects/collection.value-object';
import { GeoPoint } from '../../../shared/domain/value-objects/geo-point.value-object';
import { ResortContact } from '../../../shared/domain/value-objects/resort-contact.value-object';
import { ResortTechnicalData } from '../../../shared/domain/value-objects/resort-technical-data.value-object';
